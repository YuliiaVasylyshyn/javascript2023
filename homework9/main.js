...
division.classList.add('wrap', 'collapse', 'alpha', 'beta');
...
let clone = document.body.appendChild (division.cloneNode(true));
...
for (const one of coursesAndDurationArray) {
    ...
    block.innerText = `title: ${one.title} - monthduration: ${one.monthDuration}`;
...
for (const element of courseAndDurationArray) {
...
for (const simpson of simpsons) {
    ...
    h.innerText = `${simpson.name} ${simpson.surname}`;
...
for (const coursesArrayElement of coursesArray) {
    ...
    division.append(title, duration, ull);
    document.body.appendChild(division);
